...
To start using or contributing to this repository, clone the repo, navigate to its root directory and apply the desired Kubernetes configurations using kubectl:

```bash
git clone https://github.com/your-org/radad-devops.git
cd radad-devops
kubectl apply -f ./<directory>/<configuration-file>   
 ```
